 ...
 */
const u16 tuyaFree_inClusterList[] =
{
 ...
 */
const u16 tuyaFree_outClusterList[] =
{
#ifdef ZCL_GROUP
 ...
 */
#define tuyaFree_IN_CLUSTER_NUM		(sizeof(tuyaFree_inClusterList)/sizeof(tuyaFree_inClusterList[0]))
#define tuyaFree_OUT_CLUSTER_NUM	(sizeof(tuyaFree_outClusterList)/sizeof(tuyaFree_outClusterList[0]))

/**
 *  @brief Definition for simple description for HA profile
 */
const af_simple_descriptor_t tuyaFree_simpleDesc =
{
	HA_PROFILE_ID,                      	/* Application profile identifier */
	HA_DEV_ONOFF_SWITCH,                	/* Application device identifier */
	TUYA_FREE_ENDPOINT,                 /* Endpoint */
	2,                                  	/* Application device version */
	0,										/* Reserved */
	tuyaFree_IN_CLUSTER_NUM,           	/* Application input cluster count */
	tuyaFree_OUT_CLUSTER_NUM,          	/* Application output cluster count */
	(u16 *)tuyaFree_inClusterList,    	/* Application input cluster list */
	(u16 *)tuyaFree_outClusterList,   	/* Application output cluster list */
};
 ...
 */
const zcl_specClusterInfo_t g_tuyaFreeClusterList[] =
{
	{ZCL_CLUSTER_GEN_BASIC,			MANUFACTURER_CODE_NONE,	ZCL_BASIC_ATTR_NUM, 	basic_attrTbl,  	zcl_basic_register,		tuyaFree_basicCb},
	{ZCL_CLUSTER_GEN_IDENTIFY,		MANUFACTURER_CODE_NONE,	ZCL_IDENTIFY_ATTR_NUM,	identify_attrTbl,	zcl_identify_register,	tuyaFree_identifyCb},
#ifdef ZCL_GROUP
	{ZCL_CLUSTER_GEN_GROUPS,		MANUFACTURER_CODE_NONE,	0, 						NULL,  				zcl_group_register,		tuyaFree_groupCb},
#endif
#ifdef ZCL_SCENE
	{ZCL_CLUSTER_GEN_SCENES,		MANUFACTURER_CODE_NONE,	0,						NULL,				zcl_scene_register,		tuyaFree_sceneCb},
#endif
#ifdef ZCL_POLL_CTRL
	{ZCL_CLUSTER_GEN_POLL_CONTROL,	MANUFACTURER_CODE_NONE,	ZCL_POLLCTRL_ATTR_NUM,	pollCtrl_attrTbl, 	zcl_pollCtrl_register, 	tuyaFree_pollCtrlCb},
#endif
};

u8 TUYA_FREE_CB_CLUSTER_NUM = (sizeof(g_tuyaFreeClusterList)/sizeof(g_tuyaFreeClusterList[0]));
